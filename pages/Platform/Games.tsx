...
import { Volume2, VolumeX, Coins, Trophy, Zap, ArrowLeft, Gamepad2, Play, Star } from 'lucide-react';
...
// ... [LM_WEIGHTS, LM_GRID_MAP remain unchanged] ...
const LM_WEIGHTS = [
...
// ... [SLOT_SYMBOLS, PAYLINES remain unchanged] ...
const SLOT_SYMBOLS = [
...
export const Games: React.FC = () => {
  ...
  const [activeGame, setActiveGame] = useState<'FPC' | 'LITTLE_MARY' | 'SLOTS' | null>(null);
            ...
            <div className="grid md:grid-cols-3 gap-6">
                ...
                >
                    ...
                    <div className="absolute inset-0 flex flex-col items-center justify-center p-6 text-center z-10">
                        ...
                        <h3 className="text-2xl font-black text-white italic tracking-widest mb-1 group-hover:text-purple-400 transition">LITTLE MARY</h3>
                ...
                >
                    ...
                    <div className="absolute inset-0 flex flex-col items-center justify-center p-6 text-center z-10">
                        ...
                        <h3 className="text-2xl font-black text-white italic tracking-widest mb-1 group-hover:text-yellow-400 transition">LION SLOTS</h3>
                ...
                >
                    ...
                    <div className="absolute inset-0 flex flex-col items-center justify-center p-6 text-center z-10">
                        ...
                        <h3 className="text-2xl font-black text-white italic tracking-widest mb-1 group-hover:text-green-400 transition">HOO HEY HOW</h3>
